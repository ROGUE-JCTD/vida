    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('headquarters_address', models.ForeignKey(related_name='firedepartment_headquarters', blank=True, to='vida_core.Address', null=True)),
                ('mail_address', models.ForeignKey(blank=True, to='vida_core.Address', null=True)),
            ],
            options={
                'ordering': ('state', 'name'),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('station_address', models.ForeignKey(blank=True, to='vida_core.Address', null=True)),
            ],
            options={
