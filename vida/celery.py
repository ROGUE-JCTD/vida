...
from vida.utils.s3put import singlepart_upload
from vida.utils import convert_png_to_jpg
from celery.task import current

# set the default Django settings module for the 'celery' program.
os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'vida.settings.local')
...
def cache_thumbnail(id, upload_to_s3=False, marker=True):
    try:
        ...
        full_filename = os.path.join('/home/vida/department-thumbnails', filename)
        ...
        if not generate_thumbnail.startswith('/static'):
            ...
            shutil.copy('/webapps/vida/vida/vida/firestation/static/firestation/theme/assets/images/content/property-1.jpg', full_filename)
        ...
        if upload_to_s3:
            ...
            b = c.get_bucket('vida-static/department-thumbnails', validate=False)
